  ...
  return (
    <PageContainer>
      <div className="mx-auto max-w-xl animate-in fade-in slide-in-from-bottom-2 duration-500">
        ...
        <h1 className="mt-1 text-3xl font-semibold text-slate-950">Profile settings</h1>
        <p className="mt-2 text-sm text-slate-600">
          Update how you appear across RaviCommerce.
        </p>
        ...
        >
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:items-start">
            ...
            <div className="flex-1 space-y-2 text-center sm:text-left">
              <label
                htmlFor="avatar"
                className="inline-flex cursor-pointer rounded-md border bg-slate-50 px-4 py-2 text-sm font-semibold text-slate-800 transition hover:bg-slate-100"
              >
                Change photo
              </label>
              <input
